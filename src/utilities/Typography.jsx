...
const ModalTitle = ({ text }) => {
  return (
    <>
      <h1 className="text-[1.5rem] font-semibold text-[#2D2D2D] leading-relaxed">
        {text}
      </h1>
    </>
  );
...
const ModalSubtitle = ({ text }) => {
  return (
    <>
      <h1 className="text-[1.1rem] font-normal text-[#2D2D2D] leading-relaxed">
        {text}
      </h1>
    </>
  );
...
const NavbarSubtitle = ({ text }) => {
  return (
    <>
      <h1 className="font-normal text-[#2D2D2D] leading-relaxed text-[1rem]">
        {text}
      </h1>
    </>
  );
